...
class Database
{
    ...
    // CORRIGIDO: DB_HOST, DB_NAME, DB_USER, DB_PASS de acordo com o docker-compose.yml
    private const DB_HOST = 'mysql'; // Nome do serviço do banco de dados no docker-compose.yml
    private const DB_NAME = 'mercato_db'; // Nome do banco de dados no docker-compose.yml
    private const DB_USER = 'user';    // Usuário do banco de dados no docker-compose.yml
    private const DB_PASS = 'secret';        // Senha do usuário do banco de dados no docker-compose.yml
