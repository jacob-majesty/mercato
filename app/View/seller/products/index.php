    ...
    <div class="col-md-12">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h4 class="mb-0"><i class="fas fa-boxes"></i> Meus Produtos</h4>
                <a href="/seller/products/create" class="btn btn-success btn-sm"><i class="fas fa-plus-circle"></i> Novo Produto</a>
            </div>
            <div class="card-body p-4">
                ...
                <?php else: ?>
                    <div class="alert alert-info text-center" role="alert">
                        Você ainda não cadastrou nenhum produto. <a href="/seller/products/create" class="alert-link">Crie seu primeiro produto agora!</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function deleteProduct(productId) {
        fetch(`/seller/products/${productId}/delete`, {
            ...
            // Se precisar enviar algum dado no corpo, como um motivo de exclusão
            // body: JSON.stringify({ reason: 'Produto descontinuado' })
        })
